    ...
    (o.forEach =
      ...
      function (o, e) {
        for (var t = 0, r = this.length; t < r; t++)
          t in this && o.call(e, this[t], t, this);
      });
})(Array.prototype);
var mapObject,
  marker,
  ...
  markersData[key].forEach(function (o) {
    (marker = new google.maps.Marker({
      ...
      google.maps.event.addListener(marker, 'click', function () {
        closeInfoBox(),
          getInfoBox(o).open(mapObject, this),
          mapObject.setCenter(
            new google.maps.LatLng(o.location_latitude, o.location_longitude),
          );
      });
  });
...
function getInfoBox(o) {
  return new InfoBox({
    content:
      '<div class="map-popup-wrap"><div class="map-popup"><div class="Goodup-grid-wrap"><div class="Goodup-grid-upper"><div class="Goodup-bookmark-btn"><button type="button"><i class="lni lni-heart-filled position-absolute"></i></button></div><div class="Goodup-grid-thumb"><a href="' +
      o.listingimgURL +
      '" class="d-block text-center m-auto"><img src="' +
      o.listingImg +
      '" class="img-fluid" alt=""></a></div></div><div class="Goodup-grid-fl-wrap"><div class="Goodup-caption px-3 py-2"><div class="Goodup-author"><a href="' +
      o.authorURL +
      '"><img src="' +
      o.authorImg +
      '" class="img-fluid circle" alt=""></a></div><div class="Goodup-cates"><a href="' +
      o.listingcategoryURL +
      '">' +
      o.listingCategory +
      '</a></div><h4 class="mb-0 ft-medium medium"><a href="' +
      o.listingURL +
      '" class="text-dark fs-md">' +
      o.listingTitle +
      '</a></h4><div class="Goodup-middle-caption mt-3"><div class="Goodup-location"><i class="fas fa-map-marker-alt"></i>' +
      o.listingLocation +
      '</div><div class="Goodup-call"><i class="fas fa-phone-alt"></i>' +
      o.listingCall +
      '</div></div></div><div class="Goodup-grid-footer py-3 px-3"><div class="Goodup-ft-last"><span class="small">' +
      o.listingTime +
