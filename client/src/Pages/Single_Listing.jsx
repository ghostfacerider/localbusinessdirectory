          ...
          <div className="jbd-01 px-4 py-4">
            <div className="jbd-details">
              ...
              <div className="d-block mt-3">
                ...
                <p className="p-0 m-0">Temporibus autem quibusdam et aut officiis debitis aut rerum necessitatibus saepe eveniet ut et voluptates repudiandae sint et molestiae non recusandae. Itaque earum rerum hic tenetur</p>
              </div>
            </div>
          </div>
        </div>
                  ...
                  <div className="col-xl-3 col-lg-6 col-md-6 col-sm-6 col-6">
                    <div className="Goodup-sng-menu">
                      <div className="Goodup-sng-menu-thumb">
                        <img src="https://via.placeholder.com/550x400" className="img-fluid" alt="" />
                      </div>
          ...
          <div className="jbd-01 px-4 py-4">
            <div className="jbd-details">
              ...
              <div className="Goodup-all-features-list mt-3">
                <ul>
                  <li><div className="Goodup-afl-pace"><img src="assets/img/verify.svg" className alt="" /><span>Health Score 8.7 / 10</span></div></li>
                  <li><div className="Goodup-afl-pace"><img src="assets/img/verify.svg" className="img-fluid" alt="" /><span>Offers Delivery</span></div></li>
                  <li><div className="Goodup-afl-pace"><img src="assets/img/verify.svg" className="img-fluid" alt="" /><span>Offers Takeout</span></div></li>
                  <li><div className="Goodup-afl-pace"><img src="assets/img/verify.svg" className="img-fluid" alt="" /><span>Reservations</span></div></li>
                  <li><div className="Goodup-afl-pace"><img src="assets/img/verify.svg" className="img-fluid" alt="" /><span>Staff wears masks</span></div></li>
                  <li><div className="Goodup-afl-pace"><img src="assets/img/verify.svg" className="img-fluid" alt="" /><span>Vegan Options</span></div></li>
                  <li><div className="Goodup-afl-pace"><img src="assets/img/verify.svg" className="img-fluid" alt="" /><span>Vegetarian Options</span></div></li>
                  <li><div className="Goodup-afl-pace"><img src="assets/img/verify.svg" className="img-fluid" alt="" /><span>Accepts Credit Cards</span></div></li>
                  <li><div className="Goodup-afl-pace"><img src="assets/img/verify.svg" className="img-fluid" alt="" /><span>Casual</span></div></li>
                  <li><div className="Goodup-afl-pace"><img src="assets/img/verify.svg" className="img-fluid" alt="" /><span>Moderate Noise</span></div></li>
                  <li><div className="Goodup-afl-pace"><img src="assets/img/verify.svg" className="img-fluid" alt="" /><span>Offers Catering</span></div></li>
                  <li><div className="Goodup-afl-pace"><img src="assets/img/verify.svg" className="img-fluid" alt="" /><span>Good for Groups</span></div></li>
                  <li><div className="Goodup-afl-pace"><img src="assets/img/verify.svg" className="img-fluid" alt="" /><span>Good For Kids</span></div></li>
                  <li><div className="Goodup-afl-pace"><img src="assets/img/verify.svg" className="img-fluid" alt="" /><span>Good for Breakfast</span></div></li>
                  <li><div className="Goodup-afl-pace"><img src="assets/img/verify.svg" className="img-fluid" alt="" /><span>Brunch, Lunch, Dinner</span></div></li>
                  <li><div className="Goodup-afl-pace"><img src="assets/img/verify.svg" className="img-fluid" alt="" /><span>Private Lot Parking</span></div></li>
                  <li><div className="Goodup-afl-pace"><img src="assets/img/verify.svg" className="img-fluid" alt="" /><span>Waiter Service</span></div></li>
                  <li><div className="Goodup-afl-pace"><img src="assets/img/verify.svg" className="img-fluid" alt="" /><span>Free Wi-Fi</span></div></li>
                  <li><div className="Goodup-afl-pace"><img src="assets/img/verify.svg" className="img-fluid" alt="" /><span>Beer &amp; Wine</span></div></li>
                  <li><div className="Goodup-afl-pace"><img src="assets/img/verify.svg" className="img-fluid" alt="" /><span>Drive-Thru</span></div></li>
                  <li><div className="Goodup-afl-pace deactive"><img src="assets/img/verify.svg" className="img-fluid" alt="" /><span>Wheelchair Accessible</span></div></li>
                  <li><div className="Goodup-afl-pace deactive"><img src="assets/img/verify.svg" className="img-fluid" alt="" /><span>TV Services</span></div></li>
                  <li><div className="Goodup-afl-pace deactive"><img src="assets/img/verify.svg" className="img-fluid" alt="" /><span>Outdoor Seating</span></div></li>
                  <li><div className="Goodup-afl-pace deactive"><img src="assets/img/verify.svg" className="img-fluid" alt="" /><span>Happy Hour</span></div></li>
                  <li><div className="Goodup-afl-pace deactive"><img src="assets/img/verify.svg" className="img-fluid" alt="" /><span>Pets Allow</span></div></li>
                </ul>
              </div>
            </div>
          </div>
                ...
                <div id="accordion2" className="accordion">
                  ...
                  <div className="card">
                    <div className="card-header" id="h4">
                      <h5 className="mb-0">
                        <button className="btn btn-link collapsed" data-bs-toggle="collapse" data-bs-target="#ord4" aria-expanded="false" aria-controls="ord4">
              ...
              <div className="reviews-comments-wrap">
                ...
                <div className="reviews-comments-item">
                  ...
                  <div className="reviews-comments-item-text">
                    <h4><a href="#">Kayla E. Claxton</a><span className="reviews-comments-item-date"><i className="ti-calendar theme-cl me-1" />27 Oct 2019</span></h4>
                ...
                <div className="reviews-comments-item">
                  ...
                  <div className="reviews-comments-item-text">
                    <h4><a href="#">Amy M. Taylor</a><span className="reviews-comments-item-date"><i className="ti-calendar theme-cl me-1" />2 Nov May 2019</span></h4>
                    <span className="agd-location"><i className="lni lni-map-marker me-1" />Liverpool, London UK</span>
                    <div className="listing-rating mid"><i className="fas fa-star active" /><i className="fas fa-star active" /><i className="fas fa-star active" /><i className="fas fa-star active" /><i className="fas fa-star" /></div>
                    <div className="clearfix" />
                    <p>" Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident. "</p>
                    <div className="pull-left reviews-reaction">
                      <a href="#" className="comment-like active"><i className="ti-thumb-up" /> 12</a>
                ...
                <div className="reviews-comments-item">
                  ...
                  <div className="reviews-comments-item-text">
                    <h4><a href="#">Susan C. Daggett</a><span className="reviews-comments-item-date"><i className="ti-calendar theme-cl me-1" />10 Nov 2019</span></h4>
                    <span className="agd-location"><i className="lni lni-map-marker me-1" />Denver, United State</span>
                    <div className="listing-rating good"><i className="fas fa-star active" /><i className="fas fa-star active" /><i className="fas fa-star active" /><i className="fas fa-star active" /><i className="fas fa-star" /></div>
                    <div className="clearfix" />
                    <p>" Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident. "</p>
                    <div className="pull-left reviews-reaction">
                      <a href="#" className="comment-like active"><i className="ti-thumb-up" /> 12</a>
                ...
                <div className="row g-4">
                  <div className="col-xl-6 col-lg-6 col-md-12">
                    <div className="list-map-lot">
                      <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3559.0148908503734!2d80.97350361499701!3d26.871267983145383!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x399bfd9a9f6d1727%3A0xb87eabf63f7e4cee!2sCafe%20Repertwahr!5e0!3m2!1sen!2sin!4v1649059491407!5m2!1sen!2sin" width="100%" height={250} style={{border: 0}} allowFullScreen loading="lazy" referrerPolicy="no-referrer-when-downgrade" />
                    </div>
                    <div className="list-map-capt">
                      <div className="lio-pact"><span className="ft-medium text-info">2919 N Flores St</span></div>
                      <div className="lio-pact"><span className="hkio-oilp ft-bold">San Antonio, TX 78212</span></div>
                      <div className="lio-pact"><p className="ft-medium">Alta Vista</p></div>
                    </div>
                  </div>
                  <div className="col-xl-6 col-lg-6 col-md-12">
      ...
      <div className="col-xl-4 col-lg-4 col-md-4 col-sm-12">
        ...
        <div className="jb-apply-form bg-white rounded py-4 px-4 mb-4">
          <div className="Goodup-agent-blocks">
            <div className="Goodup-agent-thumb"><img src="https://via.placeholder.com/400x400" width={90} className="img-fluid circle" alt="" /></div>
            <div className="Goodup-agent-caption">
              <h4 className="ft-medium mb-0">Thomas R. Graves</h4>
              <span className="agd-location"><i className="lni lni-map-marker me-1" />San Francisco</span>
            </div>
            <div className="clearfix" />
          </div>
          <div className="Goodup-iuky">
            <ul>
              ...
              <li><div className="text-success">4.7</div><span>Rattings</span></li>
            ...
            <ul>
              <li>
                <div className="list-uiyt">
                  ...
                  <div className="list-uiyt-capt"><h5>Live Site</h5><p>https://www.Goodup.com/</p></div>
                </div>
              </li>
              <li>
                <div className="list-uiyt">
                  <div className="list-iobk"><i className="fas fa-envelope" /></div>
                  <div className="list-uiyt-capt"><h5>Drop a Mail</h5><p>support@Goodup.com</p></div>
                </div>
              </li>
              <li>
                <div className="list-uiyt">
