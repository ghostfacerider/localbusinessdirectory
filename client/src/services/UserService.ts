...
export const signin = async (credentials: businessTypes.Credentials, callback: (error: AxiosError | null) => void): Promise<void> => {
    try {
...
export const register = async (registrationData: businessTypes.Registration, callback: (error: AxiosError | null) => void): Promise<void> => {
    try {
