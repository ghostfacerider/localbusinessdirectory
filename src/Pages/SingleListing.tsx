...
export const SingleListing: React.FC = () => {
    ...
    async function fetchData() {
      if (!business_id) {
        setErrors((prevErrors) => ({
          ...prevErrors,
          fetch: 'Business ID is missing'
        }));
        return;
      }
      getBusinessDetailById(business_id, (businessDetails, error) => {
        if (error) {
  ...
  if (errors) {
    return <div>Error: {errors.serverMessage}</div>;
  }
            ...
            <div className="bg-white rounded mb-4">
              <div className="jbd-01 px-4 py-4">
                <div className="jbd-details">
                  <h5 className="ft-bold fs-lg">{businesses?.name}</h5>
                  <div className="d-block mt-3">
                    <p>{businesses?.owner_name}</p>
                    <p className="p-0 m-0">
                      {businesses?.address}
                ...
                <div className="jbd-details">
                  ...
                  <div className="Goodup-all-features-list mt-3">
                    <ul>
                      ...
                      <li>
                        <div className="Goodup-afl-pace">
                          <img src="assets/img/verify.svg" className="img-fluid" alt="" />
                    ...
                    <div className="reviews-comments-item">
                      ...
                      <div className="reviews-comments-item-text">
                        <h4>
                          ...
                          <span className="reviews-comments-item-date">
                            <i className="ti-calendar theme-cl me-1" />2 Nov May 2019
                          </span>
                        </h4>
                        <span className="agd-location">
                          <i className="lni lni-map-marker me-1" />
                      ...
                      <div className="col-xl-6 col-lg-6 col-md-12">
                        ...
                        <div className="list-map-capt">
                          <div className="lio-pact">
                            <span className="ft-medium text-info">2919 N Flores St</span>
                          </div>
                          <div className="lio-pact">
                            <span className="hkio-oilp ft-bold">San Antonio, TX 78212</span>
                          </div>
                          <div className="lio-pact">
                      ...
                      <div className="col-xl-6 col-lg-6 col-md-12">
                        <table className="table table-borderless">
                          <tbody>
                            <tr>
                              <th scope="row">Mon</th>
                              <td>{businesses?.working_hours?.Monday}</td>
                            ...
                            <tr>
                              <td>Fri</td>
                              <td>{businesses?.working_hours?.Friday}</td>
                              <td />
                            </tr>
                            <tr>
                              <td>Sat</td>
                            ...
                            <tr>
                              <td>Sun</td>
                              <td>{businesses?.working_hours?.Sunday}</td>
                              <td />
                            </tr>
                          </tbody>
                        </table>
                      ...
                      <div className="row">
                        ...
                        <div className="col-lg-12 col-md-12 col-sm-12">
                          <div className="form-group">
                            <button type="submit" className="btn theme-bg text-light rounded">
                              Submit Review
                            </button>
                          </div>
                        </div>
            ...
            <div className="jb-apply-form bg-white rounded py-4 px-4 mb-4">
              ...
              <div className="Goodup-iuky">
                <ul>
                  ...
                  <li>
                    <div className="text-success">{businesses?.rating}</div>
                    <span>Rattings</span>
                  </li>
                  <li>
