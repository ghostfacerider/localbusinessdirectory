      ...
      <div id="main-wrapper">
            ...
            <div className="row justify-content-center">
              <div className="col-xl-11 col-lg-12 col-md-12 col-sm-12 col-12">
                <div className="banner_caption text-center mb-5">
                  <h1 className="banner_title ft-bold mb-1">Explore Great Place in Your</h1>
                  <p className="fs-md ft-medium">
                    Explore wonderful places to stay, salons, shopping, massage, or visit local
                    areas.
                  </p>
                </div>
                <div
        ...
        {searchQuery && locationQuery ? (
          <div className="search-results">
            ...
            <p>
              Showing results for <strong>{searchQuery}</strong> in <strong>{locationQuery}</strong>
              .
            </p>
              ...
              <div className="col-xl-5 col-lg-7 col-md-9 col-sm-12">
                <div className="sec_title position-relative text-center mb-5">
                  ...
                  <h2 className="ft-bold">
                    We Have Worked with <span className="theme-cl">10,000+</span> Trusted Companies
                  </h2>
                </div>
              </div>
            </div>
