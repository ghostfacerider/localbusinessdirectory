            ...
            <div className="content_block_2 pr-3 py-4">
              <div className="content-box">
                ...
                <div className="btn-box clearfix mt-5">
                  <a href="index.html" className="download-btn play-store me-1 d-inline-flex">
                    <img src="assets/img/ios.png" width="200" alt="iOS App" />
                  </a>
                  <a href="index.html" className="download-btn play-store ms-2 mb-1 d-inline-flex">
          ...
          <div className="col-lg-5 col-md-12 col-sm-12 image-column">
            <div className="image-box">
              <figure className="image">
                <img src="assets/img/app.png" className="img-fluid" alt="App" />
              </figure>
            </div>
          </div>
        </div>
