...
export const ListingTypes: React.FC = () => {
  return (
    <>
        ...
        <div className="container">
          ...
          <div className="row align-items-center">
            <div className="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
              <ul className="nav nav-tabs small-tab mb-3" id="myTab" role="tablist">
                      ...
                      <div className="Goodup-grid-wrap">
                        <div className="Goodup-grid-upper">
                          ...
                          <div className="Goodup-grid-thumb">
                            <a href="event-detail.html" className="d-block text-center m-auto">
                              <img
                          ...
                          <div className="Goodup-overlay-caps">
                            <h4 className="mb-0 ft-medium medium">
                              <a href="event-detail.html" className="text-white fs-md">
                        ...
                        <div className="Goodup-grid-fl-wrap">
                          <div className="Goodup-grid-footer py-3 px-3">
                            <div className="Goodup-ft-first">
                              <div className="Goodup-catsin">Sport & Football</div>
                            </div>
                    ...
                    <div className="col-xl-3 col-lg-4 col-md-6 col-sm-12">
                      <div className="Goodup-grid-wrap">
                        ...
                        <div className="Goodup-grid-fl-wrap">
                          <div className="Goodup-grid-footer py-3 px-3">
                            <div className="Goodup-ft-first">
                              <div className="Goodup-catsin">Social Network</div>
                            </div>
                            <div className="Goodup-ft-last">
                      ...
                      <div className="doctor-grid-view">
                        ...
                        <div className="doctor-grid-caption">
                          <div className="doc-title-wrap">
                            <h4 className="doc-title verified">
                              <a href="single-listing-detail-4.html">Dr. Heather D. Birch</a>
                            </h4>
                          </div>
                        ...
                        <div className="doctor-grid-footer">
                          <div className="doc-foot-first">
                            <span className="av-status available">Available Today</span>
                          </div>
                    ...
                    <div className="col-xl-3 col-lg-4 col-md-6 col-sm-12">
                      <div className="doctor-grid-view">
                        ...
                        <div className="doctor-grid-caption">
                          <div className="doc-title-wrap">
                            <h4 className="doc-title verified">
                              <a href="single-listing-detail-4.html">Dr. Joyce G. Howell</a>
                            </h4>
                          </div>
                          <span className="doc-designation">MBBS, MS - General Surgery, MCh</span>
                    ...
                    <div className="col-xl-3 col-lg-4 col-md-6 col-sm-12">
                      <div className="doctor-grid-view">
                        ...
                        <div className="doctor-grid-caption">
                          <div className="doc-title-wrap">
                            <h4 className="doc-title verified">
                              <a href="single-listing-detail-4.html">Dr. Juliana J. GGoodupry</a>
                            </h4>
                          </div>
                          <span className="doc-designation">MBBS, MS - General Surgery, MCh</span>
                    ...
                    <div className="col-xl-3 col-lg-4 col-md-6 col-sm-12">
                      <div className="doctor-grid-view">
                        ...
                        <div className="doctor-grid-caption">
                          <div className="doc-title-wrap">
                            <h4 className="doc-title verified">
                              <a href="single-listing-detail-4.html">Dr. Elizabeth J. Vergara</a>
                            </h4>
                          </div>
                          <span className="doc-designation">MBBS, MS - General Surgery, MCh</span>
                    ...
                    <div className="col-xl-3 col-lg-4 col-md-6 col-sm-12">
                      <div className="doctor-grid-view">
                        ...
                        <div className="doctor-grid-caption">
                          <div className="doc-title-wrap">
                            <h4 className="doc-title verified">
                              <a href="single-listing-detail-4.html">Dr. Michelle R. McIntyre</a>
                            </h4>
                          </div>
                          <span className="doc-designation">MBBS, MS - General Surgery, MCh</span>
                    ...
                    <div className="col-xl-3 col-lg-4 col-md-6 col-sm-12">
                      <div className="doctor-grid-view">
                        ...
                        <div className="doctor-grid-caption">
                          <div className="doc-title-wrap">
                            <h4 className="doc-title verified">
                              <a href="single-listing-detail-4.html">Dr. Mary F. Holliday</a>
                            </h4>
                          </div>
                          <span className="doc-designation">MBBS, MS - General Surgery, MCh</span>
                    ...
                    <div className="col-xl-3 col-lg-4 col-md-6 col-sm-12">
                      <div className="doctor-grid-view">
                        ...
                        <div className="doctor-grid-caption">
                          <div className="doc-title-wrap">
                            <h4 className="doc-title verified">
                              <a href="single-listing-detail-4.html">Dr. Dennis K. Bales</a>
                            </h4>
                          </div>
                          <span className="doc-designation">MBBS, MS - General Surgery, MCh</span>
                    ...
                    <div className="col-xl-3 col-lg-4 col-md-6 col-sm-12">
                      <div className="doctor-grid-view">
                        ...
                        <div className="doctor-grid-caption">
                          <div className="doc-title-wrap">
                            <h4 className="doc-title verified">
                              <a href="single-listing-detail-4.html">Dr. Donald S. Herring</a>
                            </h4>
                          </div>
                          <span className="doc-designation">MBBS, MS - General Surgery, MCh</span>
                      ...
                      <div className="Goodup-grid-wrap">
                        ...
                        <div className="Goodup-grid-fl-wrap">
                          <div className="Goodup-caption px-3 py-2">
                            ...
                            <h4 className="mb-0 ft-medium medium">
                              <a href="single-listing-detail-7.html" className="text-dark fs-md">
                                New Hyundai Creta
                              </a>
                            </h4>
                      ...
                      <div className="Goodup-grid-wrap">
                        ...
                        <div className="Goodup-grid-fl-wrap">
                          <div className="Goodup-caption px-3 py-2">
                            ...
                            <h4 className="mb-0 ft-medium medium">
                              <a href="single-listing-detail-5.html" className="text-dark fs-md">
                      ...
                      <div className="Goodup-grid-wrap">
                        ...
                        <div className="Goodup-grid-fl-wrap">
                          <div className="Goodup-caption px-3 py-2">
                            ...
                            <h4 className="mb-0 ft-medium medium">
                              <a href="single-listing-detail-8.html" className="text-dark fs-md">
                        ...
                        <div className="_jb_list72_flex">
                          ...
                          <div className="_jb_list72_last">
                            <h4 className="_jb_title">
                              <a href="single-listing-detail-6.html">Application Designer</a>
                            </h4>
                    ...
                    <div className="col-xl-3 col-lg-4 col-md-6 col-sm-12">
                      <div className="_jb_list72">
                        ...
                        <div className="_jb_list72_flex">
                          ...
                          <div className="_jb_list72_last">
                            <h4 className="_jb_title">
                              <a href="single-listing-detail-6.html">Product Designer</a>
                            </h4>
                    ...
                    <div className="col-xl-3 col-lg-4 col-md-6 col-sm-12">
                      <div className="_jb_list72">
                        ...
                        <div className="_jb_list72_flex">
                          ...
                          <div className="_jb_list72_last">
                            <h4 className="_jb_title">
                              <a href="single-listing-detail-6.html">Magento Developer</a>
                            </h4>
                            <div className="_times_jb">$50k - 60k</div>
                            <div className="_jb_types internship_lite">Internship</div>
                          </div>
                    ...
                    <div className="col-xl-3 col-lg-4 col-md-6 col-sm-12">
                      <div className="_jb_list72">
                        ...
                        <div className="_jb_list72_flex">
                          ...
                          <div className="_jb_list72_last">
                            <h4 className="_jb_title">
                              <a href="single-listing-detail-6.html">WordPress Developer</a>
                            </h4>
                            <div className="_times_jb">$40k - 60k</div>
                            <div className="_jb_types fulltime_lite">Full Time</div>
                          </div>
